  ...
  return (
    <div className="clienti-dialog-overlay" role="dialog" aria-modal="true">
      <div className="clienti-dialog">
        ...
        <div className="clienti-dialog__body">Nessun pagamento relativo a questo cliente</div>
        <div className="clienti-dialog__footer">
          <button type="button" className="clienti-dialog__btn" onClick={onClose}>
            OK
          </button>
    ...
    <div className="clienti-dialog-overlay" role="dialog" aria-modal="true">
      <div className="clienti-dialog">
        ...
        <div className="clienti-dialog__body">
          Su quale dei seguenti numeri vuoi inviare il messaggio WhatsApp per <strong>{cliente.sedeOperativa.denominazione}</strong>?
        </div>
        <div className="clienti-dialog__footer">
  ...
  return (
    <div className="clienti-dialog-overlay" role="dialog" aria-modal="true">
      <div className="clienti-dialog clienti-dialog--lg">
        <div className="clienti-dialog__body">
          Per il cliente selezionato non è specificato alcun indirizzo nella Sede principale. Spostarsi sulla Sede operativa?
        </div>
        <div className="clienti-dialog__footer">
...
export function AllegatiClientiDialog({
  files,
  onSmartphone,
  onScan,
  onImport,
...
export function ImpegniDialog({ nomeCliente, onClose }: { nomeCliente: string; onClose: () => void }) {
