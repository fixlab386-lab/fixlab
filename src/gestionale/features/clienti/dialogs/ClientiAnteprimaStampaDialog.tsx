...
export type ClientiAnteprimaMeta = {
  title: string
  filename: string
}
...
export default function ClientiAnteprimaStampaDialog({ innerHtml, meta, initialCopie = 1, onClose }: Props) {
